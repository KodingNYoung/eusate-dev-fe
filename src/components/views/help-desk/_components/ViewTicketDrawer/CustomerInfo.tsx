...
import { TEMPERAMENT_COLOR_MAP, UserTemperament } from "../../utils"
  ...
  return (
    <section className="py-5 px-8 border-b border-gray-50">
      ...
      <main className="border border-gray-50 rounded-x20 p-4 grid gap-5">
        <TicketDetailItem label="Customer ID" value="#USER12345" />
        <TicketDetailItem
          label="Temperament"
          value={
            <Badge
              ...
              color={TEMPERAMENT_COLOR_MAP[UserTemperament.CALM]}
            >
              {UserTemperament.CALM}
            </Badge>
          }
        />
      </main>
