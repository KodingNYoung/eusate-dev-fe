...
const AuthLayout: FC = ({ children }) => {
  return (
    <main className="flex h-screen flex-col md:flex-row">
      <div className="bg-auth-design bg-fixed bg-cover bg-no-repeat flex flex-col items-center justify-center gap-5 text-center md:w-[40%] py-12 p-10 md:min-w-[320px]">
        <Logo type="full-gradient-white" className="h-6 md:h-12 w-fit" />
        <Typography
          as="span"
          className="py-1.5 px-3 text-white-100 border border-white-15 bg-white-10 rounded-[100px] text-regular-xxs md:text-regular-xs md:mt-5"
        >
